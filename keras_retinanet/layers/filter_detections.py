...
def filter_detections_fusion(
    ...
    def _filter_detections_fusion(scores, labels):
        ...
        if nms:
            ...
            # perform Soft-NMS
            nms_indices, nms_scores = backend.non_max_suppression_with_scores(filtered_boxes, filtered_scores, max_output_size=max_detections, iou_threshold=nms_threshold, soft_nms_sigma=0.4)
