...
from ..utils.image import read_image_bgr, read_image_fusion, read_image_entropy
...
class PascalVocGeneratorEnt(Generator):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(PascalVocGeneratorEnt, self).__init__(**kwargs)
    ...
    def load_image(self, image_index):
        ...
        return read_image_entropy(path)
