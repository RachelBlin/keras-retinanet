...
def load_model_fusion(filepath, filepath2, backbone_name1='resnet50', backbone_name2='resnet50-newname', nms=True, class_specific_filter=True):
    """ Loads a retinanet model using the correct custom objects.
...
def load_model_or_fusion(filepath, filepath2, backbone_name1='resnet50', backbone_name2='resnet50-newname', nms=True, class_specific_filter=True):
    ...
    """
    import keras.models
    from .retinanet import retinanet_bbox_or_fusion

    model1 = keras.models.load_model(filepath, custom_objects=backbone(backbone_name1).custom_objects)
    model2 = keras.models.load_model(filepath2, custom_objects=backbone(backbone_name2).custom_objects)

    model = retinanet_bbox_or_fusion(model1=model1, model2=model2, nms=nms, class_specific_filter=class_specific_filter)

    return model

def load_model_multimodal_fusion(filepath, filepath2, backbone_name1='resnet50', backbone_name2='resnet50-newname', nms=True, class_specific_filter=True):
    """ Loads a retinanet model using the correct custom objects.
    ...
    """
    import keras.models
    from .retinanet import retinanet_bbox_fusion_multimodal

    model1 = keras.models.load_model(filepath, custom_objects=backbone(backbone_name1).custom_objects)
    model2 = keras.models.load_model(filepath2, custom_objects=backbone(backbone_name2).custom_objects)

    model = retinanet_bbox_fusion_multimodal(model1=model1, model2=model2, nms=nms, class_specific_filter=class_specific_filter)

    return model

def load_model_naive_fusion_multimodal(filepath, filepath2, backbone_name1='resnet50', backbone_name2='resnet50-newname', nms=True, class_specific_filter=True):
    """ Loads a retinanet model using the correct custom objects.
    ...
    """
    import keras.models
    from .retinanet import retinanet_bbox_naive_fusion_multimodal

    model1 = keras.models.load_model(filepath, custom_objects=backbone(backbone_name1).custom_objects)
    model2 = keras.models.load_model(filepath2, custom_objects=backbone(backbone_name2).custom_objects)

    model = retinanet_bbox_naive_fusion_multimodal(model1=model1, model2=model2, nms=nms, class_specific_filter=class_specific_filter)
