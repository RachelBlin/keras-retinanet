...
def retinanet_bbox_fusion_multimodal(
    model1                = None,
    model2                = None,
    anchor_parameters     = AnchorParameters.default,
    nms                   = True,
    ...
    **kwargs
    ...
    boxes1 = layers.ClipBoxes(name='clipped_boxes1')([model1.inputs[0], boxes1])
    boxes2 = layers.RegressBoxes(name='boxes2')([anchors2, regression2])
    """boxes2_convert = tf.math.maximum(tf.constant([0., 0., 0., 0.]), tf.math.minimum(
        tf.math.multiply(boxes2, tf.constant([0.919, 1.04, 0.919, 1.04])) - tf.constant([15.4, 78, 15.4, 78]),
        tf.constant([500., 500., 500., 500.])))"""
    boxes2 = layers.ClipBoxesMultimodal(name='clipped_boxes2')([model2.inputs[0], boxes2])
...
def retinanet_bbox_naive_fusion(
    model1                = None,
    model2                = None,
    anchor_parameters     = AnchorParameters.default,
    nms                   = True,
...
def retinanet_bbox_naive_fusion_multimodal(
    model1                = None,
    model2                = None,
    anchor_parameters     = AnchorParameters.default,
    nms                   = True,
